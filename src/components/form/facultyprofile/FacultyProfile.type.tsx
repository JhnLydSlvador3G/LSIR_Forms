...
const DigitString = z.string().refine((val) => val === '' || /^\d+$/.test(val), "Must contain digits only")
...
export const FacultyDefaultValues: FacultyProfileFormData['faculty'] = [
    { gender: 'Male', basic: '', master: '', doctor: '', regular: '', partTime: '', retired: '', private: '', judges: '', prosecutor: '', otherGov: '' },
    { gender: 'Female', basic: '', master: '', doctor: '', regular: '', partTime: '', retired: '', private: '', judges: '', prosecutor: '', otherGov: '' },
]
