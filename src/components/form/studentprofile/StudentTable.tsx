...
import { ProfileRowTotal, ProfileColumnTotal, ProfileGrandTotal } from '@/components/ui/form/StudentProfileTotal'
                    ...
                    <thead className="bg-lebSecond">
                        <tr>
                            {columnHeaders.map(
                                field => {
                                    return (
                                        <th className='p-3 text-lg' key={field}>{field}</th>
                                    )
                                }
                            )}
                        </tr>
                    ...
                    <tbody>
                                                        ...
                                                        subfield => {
                                                            return (
                                                                <td key={subfield} className='p-1 text-center'>
                                                                    <form.AppField name={`profiles[${i}].${subfield}`}
                                                                        children={(field) => (
                                                                            <field.NumberField
                        ...
                        <tr>
                            <form.AppForm>
                                ...
                                {statFields.map((col) => {
                                    return (
                                        <td className='font-bold text-center overflow-auto' key={col}>
