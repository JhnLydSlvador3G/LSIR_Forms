...
import { FacultyRosterIndividual } from "./FacultyRosterIndividual";

const FacultyRosterModal = () => (
    <Dialog.Root>
        ...
        <Dialog.Portal>
            ...
            <Dialog.Content className="fixed left-1/2 top-1/2 max-h-[85vh] w-[90vw] max-w-2/3 -translate-x-1/2 -translate-y-1/2 rounded-md bg-white shadow-[var(--shadow-6)] focus:outline-none animate-contentShow overflow-auto"
                ...
                <div className="px-10 pb-6">
                    ...
                    <FacultyRosterIndividual />

                    <div className="mt-[25px] flex justify-end">
                        <Dialog.Close asChild>
                            <button className="inline-flex h-[35px] items-center justify-center rounded bg-leb px-[15px] font-medium leading-none text-white outline-none outline-offset-1 hover:bg-leb/80 focus-visible:outline-2 focus-visible:outline-green6 select-none">
                                Save changes
                            </button>
                        </Dialog.Close>
                    </div>
