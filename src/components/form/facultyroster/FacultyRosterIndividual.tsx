...
import { defaultFacultyValues } from "./FacultyRoster.type"
        ...
        return (
            <>
                ...
                <div className="flex flex-row gap-3">
                    <form.AppField name="draftFaculty.lastName">
                        {(field) => (
                            <field.TextField required label="Last Name" htmlForVal="lastName" />
                        )}
                    </form.AppField>
                    <form.AppField name="draftFaculty.firstName">
                        {(field) => (
                            <field.TextField required label="First Name" htmlForVal="firstName" />
                        )}
                    </form.AppField>
                    <form.AppField name="draftFaculty.middleName">
                        {(field) => (
                ...
                <div className="flex flex-row gap-3">
                    <form.AppField name="draftFaculty.gender">
                        {(field) => (
                    ...
                    <form.AppField name="draftFaculty.heiEmploymentStatus">
                        {(field) => (
                ...
                <div className="pt-4 pb-4 font-bold text-xl flex flex-row items-center gap-3">
                 ...
                 transition-colors duration-200"
                        onClick={(e) => {
                            form.pushFieldValue('draftFaculty.subjects', "")
                        }
                        }
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <form.AppField name="draftFaculty.subjects" mode="array">
                        {(field) =>
                            field.state.value?.map((_, i) => (
                                <form.AppField key={i} name={`draftFaculty.subjects[${i}]`}>
                                    {(subfield) => (
                ...
                <div className="pt-4 pb-4 font-bold text-xl flex flex-row items-center gap-3">
                    ...
                    <form.AppField name="draftFaculty.relevantToTeachingLoad">
                        {(field) => (
                            <button
                                type="button"
                                className="inline-flex items-center justify-center w-6 h-6 rounded-full 
             ...
             transition-colors duration-200"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <form.AppField name="draftFaculty.relevantToTeachingLoad" mode="array">
                        {(field) =>
                            field.state.value?.map((_, i) => (
                                <form.AppField key={i} name={`draftFaculty.relevantToTeachingLoad[${i}]`}>
                                    {(subfield) => (
                                        <div className="flex items-start gap-2 w-full">
                                            <div className="flex-1">
                                                <subfield.TextField
